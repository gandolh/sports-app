...
import { USERNAME_RULE, isValidUsername } from '../../persistence/codec.ts'
 ...
 * restated here — `isValidUsername` and `USERNAME_RULE` are the same exports
 * `setCurrentUsername` and the service validate against, so the blur message and
 * the store's own rejection cannot drift apart.
 *
